...
const Partner = () => {
    return (
        <div className=' text-base-content flex flex-col  lg:flex-row justify-between items-center px-10 my-20 '>
            <div className=''><Image src={'/logos/slack.png'} alt="slack" width={140} height={36} /></div>

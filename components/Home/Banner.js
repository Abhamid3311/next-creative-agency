...
const Banner = () => {
    return (
        <div className="hero min-h-screen bg-secondary text-primary px-10">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <Image src="/logos/Frame.png" width={825} height={622} className="max-w-sm rounded-lg shadow-2xl" alt='banner-frame' />
                <div>
